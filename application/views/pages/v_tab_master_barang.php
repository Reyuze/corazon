<table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <td><?php echo currency_format($row->hargajual);?></td>
        <td>
    ...
    <form class="form-horizontal" method="post" action="<?php echo site_url('master/tambah_barang')?>">
        <div class="modal-body">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="hargajual" type="text" placeholder="Input Harga Jual...">
                </div>
            </div>
        </div>
            ...
            <form class="form-horizontal" method="post" action="<?php echo site_url('master/edit_barang')?>">
                <div class="modal-body">
                    ...
                    <div class="control-group">
                        <label class="control-label">Harga Jual</label>
                        <div class="controls">
                            <input name="hargajual" type="text" value="<?php echo $row->hargajual;?>">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
