...
<head>
    ...
    <meta name="author" content="BPJS Ketenagakerjaan Pekanbaru Kota">
    ...
    <style>
        ...
        body {
            ...
            color: #fff;
            background: url("<?php echo base_url('asset/img/flowers.png') ?>") repeat #444444;
        }
...
<div class="container">
    ...
    <div class="alert alert-info text-center " hidden="true" >
    ...
    <hr>
    <div class="footer">
        <p>&copy; Created By : <a href="http://www.bpjsketenagakerjaan.go.id/kanwil/909/KANWIL-SUMATRA-BARAT-DAN-KEP.-RIAU.html" target="_blank"><strong>BPJS Ketenagakerjaan Pekanbaru Kota</strong></a></p>
    </div>
</div>
</body>
