...
class CI_Cart {
	...
	function _save_cart()
	{
		...
		foreach ($this->_cart_contents as $key => $val)
		{
			...
			$total += (($val['price']*(100-$val['disc'])/100) * $val['qty']);
			$items += $val['qty'];

			// Set the subtotal
			$this->_cart_contents[$key]['subtotal'] = (($this->_cart_contents[$key]['price']*(100-$this->_cart_contents[$key]['disc'])/100 )* $this->_cart_contents[$key]['qty']);
		}
